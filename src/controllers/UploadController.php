<?php namespace Jleach\Dataimport\Controllers;
...
class UploadController extends \BaseController{
    ...
    protected static function latest()
        {
            $count = count(\Jleach\Dataimport\Models\Upload::all());
            $latest = \Jleach\Dataimport\Models\Upload::find($count)->filename;
            return $latest;  
        }
    protected static function getFilenames()
        {
            $uploads = \Jleach\Dataimport\Models\Upload::all();
            $filenames = array();
    ...
    protected static function getUpdated()
        {
            $updates = \Jleach\Dataimport\Models\Upload::all();
